...
export function calculateShipping(weight, country, orderTotal) {
  ...
  if (country === "US") {
    ...
    if (weight <= 5) return 10; // yaha bhi if condition laga sakte he par jab pehli 2 condition ke liye laga diya he to agar dono true nai hui to last me return chalega hi 
    return 15;
  }
